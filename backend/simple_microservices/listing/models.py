...
class Listing(Base):
    ...
    nlp_cat1 = Column(String(100), nullable=True, index=True)
    nlp_cat2 = Column(String(100), nullable=True, index=True)
    nlp_cat3 = Column(String(100), nullable=True, index=True)
